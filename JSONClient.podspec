#
#  Be sure to run `pod spec lint JSONClient.podspec' to ensure this is a
...
DESC
  ...
  s.homepage     = "https://github.com/jrtibbetts/JSONClient"
  ...
  s.author             = { "Jason R Tibbetts" => "jason@tibbetts.net" }
  # Or just: s.author    = "Jason R Tibbetts"
  # s.authors            = { "Jason R Tibbetts" => "jason@tibbetts.net" }
  s.social_media_url   = "http://twitter.com/nrith"
  ...
  s.source       = { :git => "https://github.com/jrtibbetts/JSONClient.git", :tag => "#{s.version}" }
  ...
  s.dependency "OAuthSwift/OAuthSwift" #, "~> 1.1.1"
  s.dependency "mxcl/PromiseKit" #, "~> 6.2.1"
